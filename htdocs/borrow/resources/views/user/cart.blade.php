        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn btn-outline-primary" @click="clearCart()">เคลียร์ตระกร้า</button>
                    <button type="button" class="btn btn-success" @click="creatOrder()">ยืนยันรายการ</button>
                </div>
            </div>
        </div>
    </div>
